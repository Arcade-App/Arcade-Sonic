...
namespace Aptos.Unity.Rest
{
    ...
    public class RestClient : MonoBehaviour
    {
        ...
        {
            Instance = this;
            Endpoint = new Uri("https://fullnode.testnet.aptoslabs.com/v1"); //WebGL Debug 28th Sept 17:21
        }
        ...
        public IEnumerator GetAccountBalance(Action<AccountResourceCoin.Coin, ResponseInfo> callback, Accounts.AccountAddress accountAddress)
        {
            ...
            Debug.Log("Debug 10: Inside GetAccountBalance Coroutine");


            string accountsURL = Endpoint + "/accounts/" + accountAddress.ToString() + "/resource/" + Constants.APTOS_COIN_TYPE;

            Debug.Log("Debug 11: accounts URL: " + accountsURL);


            Uri accountsURI = new Uri(accountsURL);

            Debug.Log("Debug 12: accounts URI: " + accountsURI);


            UnityWebRequest request = UnityWebRequest.Get(accountsURI);
            request.SendWebRequest();

            Debug.Log("Debug 13: Request: " + request);
            ...
            Debug.Log("Debug 13: Response Info: " + responseInfo);
            ...
            if (request.result == UnityWebRequest.Result.ConnectionError)
            {
                ...
                Debug.Log("Debug 13.1: Connection Error Response info : " + request);
            ...
            else if (request.responseCode == 404)
            {
                ...
                Debug.Log("Debug 13.2: 404 Error: " + request);
            ...
            else
            {
                ...
                Debug.Log("Debug 13.3: Account Resource Coin: " + request.downloadHandler.text);
        ...
        public byte[] StringToByteArray(String hex)
        {
            ...
            if (hex.Length % 2 != 0)
            {
                throw new FormatException("Invalid hex string. The length must be even.");
            }
        ...
        #region (IGNORE) OLD TOURNAMENT FUNCTIONS 
        //Works
        //public IEnumerator EnterTournamentTransactionWrapper(Action<Transaction, ResponseInfo> callback, Account participant, string tournamentAddress)
        //{
        //    // STEP 1: Create Transaction Arguments
        //    Arguments arguments = new Arguments()
        //    {
        //        ArgumentStrings = new string[] { tournamentAddress }, // Pass only the tournament address as a single argument
        //        //MutateSettings = new bool[] { } // No mutable settings needed, clear this field
        //    };

        //    //Debug.Log("T Address 2: " + tournamentAddress);


        //    // STEP 2: Create Payload Containing Transaction Arguments
        //    TransactionPayload enterTournamentPayload = new TransactionPayload()
        //    {
        //        Type = Constants.ENTRY_FUNCTION_PAYLOAD,
        //        Function = "0xe5da06c67c3020364e21e7f17f2c24297ee6da15026a61a10cdb51d23d9341ed::tourn4::enter_tournament", // Correct entry function ID
        //        TypeArguments = new string[] { }, // No type arguments required
        //        Arguments = arguments
        //    };

        //    string payloadJson = JsonConvert.SerializeObject(enterTournamentPayload, new TransactionPayloadConverter());

        //    // Log the payload for debugging
        //    Debug.Log("Transaction Payload: " + payloadJson);
        ...
        //    // Coroutine to get the account's current sequence number
        //    Coroutine cor_sequenceNumber = StartCoroutine(GetAccountSequenceNumber((_sequenceNumber, _responseInfo) => {
        //        sequenceNumber = _sequenceNumber;
        //        responseInfo = _responseInfo;
        ...
        //    // Check for errors in obtaining the sequence number
        //    if (responseInfo.status != ResponseInfo.Status.Success)
        //    {
        //        callback(null, responseInfo);
        //        yield break;
        ...
        //    var txnRequest = new TransactionRequest()
        //    {
        //        Sender = participant.AccountAddress.ToString(),
        //        SequenceNumber = sequenceNumber,
        //        MaxGasAmount = Constants.MAX_GAS_AMOUNT.ToString(),
        //        GasUnitPrice = Constants.GAS_UNIT_PRICE.ToString(),
        //        ExpirationTimestampSecs = expirationTimestamp,
        //        Payload = enterTournamentPayload
        //    };

        //    string txnRequestJson = JsonConvert.SerializeObject(txnRequest, new TransactionRequestConverter());

        //    ///////////////////////////////////////////////////////////////////////
        //    // 2) Submit raw transaction to get encoded submission
        //    ///////////////////////////////////////////////////////////////////////
        //    string encodedSubmission = "";
        ...
        //    // Check if the encoded submission was generated successfully
        //    if (string.IsNullOrEmpty(encodedSubmission))
        //    {
        //        responseInfo.status = ResponseInfo.Status.Failed;
        //        responseInfo.message = "Failed to encode transaction.";
        //        callback(null, responseInfo);
        //        yield break;
        //    }
        ...
        //    ///////////////////////////////////////////////////////////////////////
        //    byte[] toSign = StringToByteArray(encodedSubmission.Trim('"')[2..]);
        //    byte[] signature = participant.Sign(toSign);

        //    txnRequest.Signature = new SignatureData()
        //    {
        //        Type = "ed25519_signature",
        //        PublicKey = "0x" + CryptoBytes.ToHexStringLower(participant.PublicKey),
        //        Signature = "0x" + CryptoBytes.ToHexStringLower(signature)
        //    };
        ...
        //    string transactionURL = Endpoint + "/transactions";
        //    Uri transactionsURI = new Uri(transactionURL);
        //    using (var request = new UnityWebRequest(transactionsURI, "POST"))
        //    {
        //        byte[] jsonToSend = new System.Text.UTF8Encoding().GetBytes(txnRequestJson);
        //        request.uploadHandler = new UploadHandlerRaw(jsonToSend);
        //        request.downloadHandler = new DownloadHandlerBuffer();
        ...
        //        {
        //            responseInfo.status = ResponseInfo.Status.Failed;
        //            responseInfo.message = "Error submitting transaction: " + request.error;
        //            callback(null, responseInfo);
        //        }
        //        else
        //        {
        //            string response = request.downloadHandler.text;
        //            Transaction enterTournamentTxn = JsonConvert.DeserializeObject<Transaction>(response, new TransactionConverter());

        //            responseInfo.status = ResponseInfo.Status.Success;
        //            responseInfo.message = response;
        //            callback(enterTournamentTxn, responseInfo);
        //        }
        //    }
        //}

        //Works
        //public IEnumerator RecordScoreTransactionWrapper(Action<Transaction, ResponseInfo> callback, Account participant, string tournamentAddress, ulong score)
        //{
        //    // STEP 1: Create Transaction Arguments
        //    Arguments arguments = new Arguments()
        //    {
        //        ArgumentStrings = new string[] { tournamentAddress, score.ToString() }, // Pass the tournament address and the score as strings
        //        //MutateSettings = new bool[] { } // No mutate settings needed
        //    };

        //    // STEP 2: Create Payload Containing Transaction Arguments
        //    TransactionPayload recordScorePayload = new TransactionPayload()
        //    {
        //        Type = Constants.ENTRY_FUNCTION_PAYLOAD,
        //        Function = "0xe5da06c67c3020364e21e7f17f2c24297ee6da15026a61a10cdb51d23d9341ed::tourn4::record_score", // Correct entry function ID
        //        TypeArguments = new string[] { }, // No type arguments required
        //        Arguments = arguments
        //    };

        //    string payloadJson = JsonConvert.SerializeObject(recordScorePayload, new TransactionPayloadConverter());
        ...
        //        {
        //            string response = request.downloadHandler.text;
        //            Transaction recordScoreTxn = JsonConvert.DeserializeObject<Transaction>(response, new TransactionConverter());

        //            responseInfo.status = ResponseInfo.Status.Success;
        //            responseInfo.message = response;
        //            callback(recordScoreTxn, responseInfo);
        //        }
        //    }
        //}

        //Works
        //public IEnumerator GetParticipantScoreTransactionWrapper(Action<ulong, ResponseInfo> callback, string tournamentAddress, string participantAddress)
        //{
        //    // STEP 1: Create the payload for calling the view function
        //    var getParticipantScorePayload = new
        //    {
        //        function = "0xe5da06c67c3020364e21e7f17f2c24297ee6da15026a61a10cdb51d23d9341ed::tourn4::get_participant_score", // Correct entry function ID
        //        type_arguments = new string[] { }, // No type arguments required
        //        arguments = new string[] { tournamentAddress, participantAddress } // Tournament and participant address as strings
        //    };

        //    string payloadJson = JsonConvert.SerializeObject(getParticipantScorePayload);

        //    // Log the payload for debugging
        //    Debug.Log("Transaction Payload: " + payloadJson);

        //    ///////////////////////////////////////////////////////////////////////
        //    // 1) Send a query to get the participant's score
        //    ///////////////////////////////////////////////////////////////////////
        //    string response = "";
        //    ResponseInfo responseInfo = new ResponseInfo();

        //    // Use UnityWebRequest to send the payload to the Aptos node
        //    string queryURL = Endpoint + "/view"; // Correct endpoint for view functions
        //    Uri queryURI = new Uri(queryURL);
        //    using (var request = new UnityWebRequest(queryURI, "POST"))
        //    {
        ...
        //        {
        //            responseInfo.status = ResponseInfo.Status.Failed;
        //            responseInfo.message = "Error querying participant score: " + request.error;
        //            callback(0, responseInfo);
        //        }
        //        else
        //        {
        ...
        //            try
        //            {
        //                // Deserialize the response as a list of strings
        //                var scoreResponse = JsonConvert.DeserializeObject<List<string>>(response);

        //                // Convert the first element to ulong
        //                ulong participantScore = ulong.Parse(scoreResponse[0]);

        //                responseInfo.status = ResponseInfo.Status.Success;
        //                callback(participantScore, responseInfo);
        //            }
        //            catch (Exception e)
        //            {
        //                responseInfo.status = ResponseInfo.Status.Failed;
        //                responseInfo.message = "Failed to parse score: " + e.Message;
        //                callback(0, responseInfo);
        //            }
        //        }
        //    }
        ...
        //Works
        //public IEnumerator GetParticipantsTransactionWrapper(Action<List<Participant>, ResponseInfo> callback, string tournamentAddress)
        //{
        //    // STEP 1: Create the arguments for the view function
        //    Arguments arguments = new Arguments()
        //    {
        //        ArgumentStrings = new string[] { tournamentAddress }, // Tournament address
        //        //MutateSettings = new bool[] { } // No mutable settings needed
        //    };

        //    // STEP 2: Create the payload for calling the view function
        //    var getParticipantsPayload = new
        //    {
        //        function = "0xe5da06c67c3020364e21e7f17f2c24297ee6da15026a61a10cdb51d23d9341ed::tourn4::get_participants", // Correct entry function ID
        //        type_arguments = new string[] { }, // No type arguments required
        //        arguments = new string[] { tournamentAddress } // Only the tournament address as a string
        //    };

        //    string payloadJson = JsonConvert.SerializeObject(getParticipantsPayload);

        //    // Log the payload for debugging
        //    Debug.Log("Transaction Payload: " + payloadJson);

        //    ///////////////////////////////////////////////////////////////////////
        //    // 1) Send a query to get the list of participants
        //    ///////////////////////////////////////////////////////////////////////
        //    string response = "";
        //    ResponseInfo responseInfo = new ResponseInfo();
        ...
        //        {
        //            responseInfo.status = ResponseInfo.Status.Failed;
        //            responseInfo.message = "Error querying participants: " + request.error;
        //            callback(new List<Participant>(), responseInfo);
        //        }
        //        else
        //        {
        //            response = request.downloadHandler.text;
        ...
        //            try
        //            {
        //                // Deserialize the response properly, accounting for the nested array
        //                var participants = JsonConvert.DeserializeObject<List<List<Participant>>>(response);

        //                // Flatten the nested list into a single list of participants
        //                List<Participant> flatParticipants = participants.SelectMany(p => p).ToList();

        //                responseInfo.status = ResponseInfo.Status.Success;
        //                callback(flatParticipants, responseInfo);
        //            }
        //            catch (Exception e)
        //            {
        //                responseInfo.status = ResponseInfo.Status.Failed;
        //                responseInfo.message = "Failed to parse participants: " + e.Message;
        //                callback(new List<Participant>(), responseInfo);
        //            }
        //        }
        //    }
        ...
        ////Works
        //public IEnumerator GetTournamentBalanceTransactionWrapper(Action<ulong, ResponseInfo> callback, string tournamentAddress)
        //{
        //    // STEP 1: Create the payload for calling the view function
        //    var getTournamentBalancePayload = new
        //    {
        //        function = "0xe5da06c67c3020364e21e7f17f2c24297ee6da15026a61a10cdb51d23d9341ed::tourn4::get_tournament_balance", // Correct entry function ID
        //        type_arguments = new string[] { }, // No type arguments required
        //        arguments = new string[] { tournamentAddress } // Tournament address as a string
        //    };

        //    string payloadJson = JsonConvert.SerializeObject(getTournamentBalancePayload);

        //    // Log the payload for debugging
        //    Debug.Log("Transaction Payload: " + payloadJson);

        //    ///////////////////////////////////////////////////////////////////////
        //    // 1) Send a query to get the tournament balance
        //    ///////////////////////////////////////////////////////////////////////
        //    string response = "";
        //    ResponseInfo responseInfo = new ResponseInfo();
        ...
        //        {
        //            responseInfo.status = ResponseInfo.Status.Failed;
        //            responseInfo.message = "Error querying tournament balance: " + request.error;
        //            callback(0, responseInfo);
        //        }
        //        else
        //        {
        ...
        //            {
        //                // Deserialize the response as a list of strings
        //                var balanceResponse = JsonConvert.DeserializeObject<List<string>>(response);

        //                // Convert the first element to ulong
        //                ulong tournamentBalance = ulong.Parse(balanceResponse[0]);

        //                responseInfo.status = ResponseInfo.Status.Success;
        //                callback(tournamentBalance, responseInfo);
        //            }
        //            catch (Exception e)
        //            {
        //                responseInfo.status = ResponseInfo.Status.Failed;
        //                responseInfo.message = "Failed to parse balance: " + e.Message;
        //                callback(0, responseInfo);
        //            }
        //        }
        //    }
        ...
        //public IEnumerator GetTournamentInfoTransactionWrapper(Action<TournamentInfo, ResponseInfo> callback, string tournamentAddress)
        //{
        //    // STEP 1: Create the payload for calling the view function
        //    var getTournamentInfoPayload = new
        //    {
        //        function = "0xe5da06c67c3020364e21e7f17f2c24297ee6da15026a61a10cdb51d23d9341ed::tourn4::get_tournament_info", // Correct entry function ID
        //        type_arguments = new string[] { }, // No type arguments required
        //        arguments = new string[] { tournamentAddress } // Tournament address as a string
        //    };

        //    string payloadJson = JsonConvert.SerializeObject(getTournamentInfoPayload);

        //    // Log the payload for debugging
        //    Debug.Log("Transaction Payload: " + payloadJson);

        //    ///////////////////////////////////////////////////////////////////////
        //    // 1) Send a query to get the tournament info
        //    ///////////////////////////////////////////////////////////////////////
        //    string response = "";
        //    ResponseInfo responseInfo = new ResponseInfo();
        ...
        //        {
        //            responseInfo.status = ResponseInfo.Status.Failed;
        //            responseInfo.message = "Error querying tournament info: " + request.error;
        //            callback(null, responseInfo);
        //        }
        //        else
        //        {
        ...
        //            {
        //                // Deserialize the response as a list of strings
        //                var infoResponse = JsonConvert.DeserializeObject<List<string>>(response);

        //                // Parse the individual values
        //                ulong numParticipants = ulong.Parse(infoResponse[0]);
        //                ulong startTime = ulong.Parse(infoResponse[1]);
        //                ulong endTime = ulong.Parse(infoResponse[2]);

        //                // Create a TournamentInfo object to store these values
        //                TournamentInfo tournamentInfo = new TournamentInfo(numParticipants, startTime, endTime);

        //                responseInfo.status = ResponseInfo.Status.Success;
        //                callback(tournamentInfo, responseInfo);
        //            }
        //            catch (Exception e)
        //            {
        //                responseInfo.status = ResponseInfo.Status.Failed;
        //                responseInfo.message = "Failed to parse tournament info: " + e.Message;
        //                callback(null, responseInfo);
        //            }
        //        }
        //    }
        ...
        #region NEW TOURNAMENT REGION
        public IEnumerator StartNewTournamentTransactionWrapper(
                                                                Action<Transaction, ResponseInfo> callback,
                                                                Account account,
                                                                string tournamentId,
                                                                ...
                                                                string endTime)
        {
            // STEP 1: Create Transaction Arguments (as strings)
            Arguments arguments = new Arguments()
            {
                ArgumentStrings = new string[]
                {
            ...
            {
                Type = Constants.ENTRY_FUNCTION_PAYLOAD,
                Function = tournamentManagerAddress + "::" + tournamentContractName + "::start_new_tournament", // Correct entry function ID
                TypeArguments = new string[] { }, // No type arguments required
                Arguments = arguments
            };

            string payloadJson = JsonConvert.SerializeObject(payload, new TransactionPayloadConverter());
            Debug.Log("Transaction Payload: " + payloadJson);

            // STEP 3: Create Transaction Request
            string sequenceNumber = "";
            ResponseInfo responseInfo = new ResponseInfo();
            ...
            string expirationTimestamp = (DateTime.Now.ToUnixTimestamp() + Constants.EXPIRATION_TTL).ToString();
            TransactionRequest txnRequest = new TransactionRequest()
            {
                Sender = account.AccountAddress.ToString(),
                SequenceNumber = sequenceNumber,
            ...
            using (var request = new UnityWebRequest(transactionsURI, "POST"))
            {
                ...
                {
                    string response = request.downloadHandler.text;
                    Transaction txn = JsonConvert.DeserializeObject<Transaction>(response, new TransactionConverter());

                    responseInfo.status = ResponseInfo.Status.Success;
                    responseInfo.message = response;
                    callback(txn, responseInfo);
                }
            }
        }
        ...
        public IEnumerator EnterTournamentTransactionWrapper(
                                                            Action<Transaction, ResponseInfo> callback,
                                                            Account participant,
                                                            string tournamentId,
                                                            string userId)
        {
            ...
            {
                Type = Constants.ENTRY_FUNCTION_PAYLOAD,
                Function = tournamentManagerAddress + "::" + tournamentContractName + "::enter_tournament", // Correct entry function ID
                TypeArguments = new string[] { }, // No type arguments required
                Arguments = arguments
            };
        ...
        public IEnumerator RecordScoreTransactionWrapper(
                                                        Action<Transaction, ResponseInfo> callback,
                                                        Account participant,
                                                        string tournamentId,
                                                        string score)
        {
            ...
            {
                Type = Constants.ENTRY_FUNCTION_PAYLOAD,
                Function = tournamentManagerAddress + "::" + tournamentContractName + "::record_score", // Correct entry function ID
                TypeArguments = new string[] { }, // No type arguments required
                Arguments = arguments
            };
        ...
        public IEnumerator GetLeaderboardTransactionWrapper(Action<List<Participant>, ResponseInfo> callback, string tournamentId)
        {
            // STEP 1: Create the payload for calling the view function
            var getLeaderboardPayload = new
            {
                function = tournamentManagerAddress + "::" + tournamentContractName + "::get_leaderboard", // Correct entry function ID
                type_arguments = new string[] { }, // No type arguments required
                arguments = new string[] { tournamentId } // Tournament ID as a string
            };

            string payloadJson = JsonConvert.SerializeObject(getLeaderboardPayload);

            // Log the payload for debugging
            Debug.Log("Transaction Payload: " + payloadJson);

            ///////////////////////////////////////////////////////////////////////
            // 1) Send a query to get the leaderboard
            ///////////////////////////////////////////////////////////////////////
            string response = "";
            ResponseInfo responseInfo = new ResponseInfo();
            ...
            using (var request = new UnityWebRequest(queryURI, "POST"))
            {
                ...
                {
                    responseInfo.status = ResponseInfo.Status.Failed;
                    responseInfo.message = "Error querying leaderboard: " + request.error;
                    callback(null, responseInfo);
                }
                else
                {
                    ...
                    try
                    {
                        // Deserialize the response into a list of participants
                        var leaderboardResponse = JsonConvert.DeserializeObject<List<Participant>>(response);

                        responseInfo.status = ResponseInfo.Status.Success;
                        callback(leaderboardResponse, responseInfo);
                    }
                    catch (Exception e)
                    {
                        responseInfo.status = ResponseInfo.Status.Failed;
                        responseInfo.message = "Failed to parse leaderboard: " + e.Message;
                        callback(null, responseInfo);
                    }
                }
            }
        ...
        public IEnumerator GetTournamentInfoTransactionWrapper(Action<TournamentInfo, ResponseInfo> callback, string tournamentId)
        {
            // STEP 1: Create the payload for calling the view function
            var getTournamentInfoPayload = new
            {
                function = tournamentManagerAddress + "::" + tournamentContractName + "::get_tournament_info", // Correct entry function ID
                type_arguments = new string[] { }, // No type arguments required
                arguments = new string[] { tournamentId } // Tournament ID as a string
            };
            ...
            ///////////////////////////////////////////////////////////////////////
            // 1) Send a query to get the tournament information
            ///////////////////////////////////////////////////////////////////////
            string response = "";
            ResponseInfo responseInfo = new ResponseInfo();
            ...
            using (var request = new UnityWebRequest(queryURI, "POST"))
            {
                ...
                else
                {
                    ...
                    try
                    {
                        // Deserialize the response into the tournament info tuple
                        var tournamentInfoResponse = JsonConvert.DeserializeObject<List<string>>(response);

                        // Convert the response into the expected data structure
                        TournamentInfo tournamentInfo = new TournamentInfo
                        {
                            StartTime = ulong.Parse(tournamentInfoResponse[0]),
                            EndTime = ulong.Parse(tournamentInfoResponse[1]),
                            NumParticipants = ulong.Parse(tournamentInfoResponse[2]),
                            CreatorAddress = tournamentInfoResponse[3],
                            EntryFee = ulong.Parse(tournamentInfoResponse[4]),
                            PrizePoolAmount = ulong.Parse(tournamentInfoResponse[5]),
                            Status = byte.Parse(tournamentInfoResponse[6])
                        };
        ...
        public IEnumerator GetParticipantScoreTransactionWrapper(Action<ulong, ResponseInfo> callback, string tournamentId, string userId)
        {
            // STEP 1: Create the payload for calling the view function
            var getParticipantScorePayload = new
            {
                function = tournamentManagerAddress + "::" + tournamentContractName + "::get_participant_score", // Correct entry function ID
                type_arguments = new string[] { }, // No type arguments required
                arguments = new string[] { tournamentId, userId } // Tournament ID and user ID as strings
            };
...
public class TournamentInfo
{
    ...
    public ulong NumParticipants { get; set; }
    public string CreatorAddress { get; set; }
    public ulong EntryFee { get; set; }
    public ulong PrizePoolAmount { get; set; }
