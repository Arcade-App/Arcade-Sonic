...
public class Top30GameButton : MonoBehaviour
{
    ...
    public void OnChooseTop30GameButtonClicked()
    {

        StartCoroutine(OnChooseTop30GameButtonClickedCoroutine());


    }


    public IEnumerator OnChooseTop30GameButtonClickedCoroutine()
    {
